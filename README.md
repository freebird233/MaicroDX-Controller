...
<br> **短接STBY=A_mode 断路STBY=B_mode**
<br>
<br>
...
它由两部分组成: "外壳" "外壳底板"，相当于将PCB板夹在中间，(过盈配合) <br> 
外壳有比较大的悬空区域，请使用不同材料的耗材作为支撑接触面！例如:PLA支撑PETG <br>
(后续我会上传3MF文件) <br>

<br> <br>
# 4.焊接元器件
焊接通常遵循从难到易的顺序，比如TYPE-C母座，FPC母座，WS2812B灯珠这些部件推荐优先处理 <br>
