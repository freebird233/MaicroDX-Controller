...
<br> <br> <br>
    ...
    该项目为学习分享，按键通过模拟键盘输入，您需要自行解决软件方面的问题。
...
| :--- | :--- |
| 一体化模式，便携首选。cc线直连轮盘与设备。用"纳米"胶布把轮盘贴在在平板上游玩 (**焊接所有元器件**) | 外接控制模式, 搭配[Maicrodx框体](https://github.com/freebird233/MaicroDX)使用,**只焊ws2802灯珠与FPC底座**,连接到外部控制板(适配V2版模型的80%缩放尺寸) |
<br>
<br> 
...
<br> <br> <br> 
# 1.购买元件
1. 电阻5.1KΩ ±1% 0805封装 2元
2. 电阻10KΩ ±1% 0805封装 2元
3. 电容0.1uf ±1% 0805封装 2元
4. ws2812B 幻彩灯珠 侧投式 *8  约6元
5. Cheery 矮红轴 *8 约20元
6. USBC母座 卧贴 TYPE-C 16PIN 2MD(073) 1元
7. CH552g 单片机 *1 2元
8. FPC排线底座 12P *2 AFC01-S12FCA-00 (可选，B_mode外接板方案使用) 2元
9. FPC排线 12P 50cm 反向 *1 1~2元
10. HC-1.25-2PWT 平衡头座 （可选，mdx外框使用，热插拔9P按键排线) 1元
11. FPC排线 12P 反向 (可选B_mode外接板方案使用) 1元
12.  M1.4*4.5镍 沉头自攻螺丝 *8 (可选，装饰用) 5.8元
<br> <br>
...
# 2.订购PCB板
-尽可能选择较薄的板厚<br><br>
例如嘉立创最近取消了冷门工艺费用，双层板，0.8厚，白色，有铅喷锡。<br>
样板订单单件价格约 16/张 <br><br>如果选择了非白色颜色，在按键的左右间隙会看到电路板，影响美观
...
<br> <br>
# 4.焊接元器件
焊接通常遵循从难到易的顺序。TYPE-C母座，FPC母座，WS2812B灯珠这些部件通常优先处理 <br> (使用锡膏与大量的助焊剂) <br>
如果使用回流焊工艺，请注意FPC底座在板子的底面
<br>
<br>
如果使用外接控制板，圆盘pcb只焊接灯光与FPC底座，其余的元器件如图所示<br>
...
<br>(焊盘位有留空)(12P的FPC座位于底层)

<br> <br>
# 5.烧录程序
在官网下载烧录软件[WCHISPStudio](https://www.wch.cn/downloads/WCHISPTool_Setup_exe.html) <br> 
在[Release处](https://github.com/freebird233/MaicroDX-Controller/releases)下载MaicroDX.hex固件程序<br>
...
- 检查信号灯是否依次亮起（就像上面的视频）由于WS2812的串联信号传输特性，当一个灯珠信号脱焊，会导致后面的所有灯熄灭。<br><br>

- 短接各按键的两个焊盘，检查是否有键控信号输出，且白灯转变为黄灯<br>附: [按键测试网站](https://www.zfrontier.com/lab/keyboardTester)

<br>
<br>

# 6.装配
<br>确认各项无误后，将FPC板子装入3D打印外壳中，安装矮红轴，焊锡填补轴针处间隙 <br>
合上后盖
