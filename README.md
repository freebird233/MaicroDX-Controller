...
| :--- | :--- |
| 一体化模式，便携首选。cc线直连轮盘与设备。用"纳米"胶布把轮盘贴在在平板上游玩 (**焊接所有元器件**) | 外接控制模式, 搭配[Maicrodx框体](https://github.com/freebird233/MaicroDX)使用,**只焊ws2802灯珠与FPC底座**,连接到外部控制板再通过数据线传给平板。(适配V2版模型的80%缩放尺寸) |
<br>
<br> 
